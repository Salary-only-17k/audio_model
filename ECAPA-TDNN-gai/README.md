...
生成train数据的文本
```python
python cope_data/gender_train_list.py --data_dir <data/to/dir/> --save_txt <to/path/**txt>
```
生成val数据的文本
```python
python cope_data/gender_val_list.py --data_dir <data/to/dir/> --save_txt <to/path/**txt>
```
# 训练
```bash
sh train.sh exps/exp1 
```
